...
4) Copy the input Shapefile into the input folder! Don't forget to copy any dependencies of the SHP file as well! Rename the files to: ``` buildings.<extension> ```
5) Run ``` pixi run python <file.py> ```
6) Check the output files (e.g. in QGIS).
